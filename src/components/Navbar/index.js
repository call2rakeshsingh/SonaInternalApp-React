          ...
          <div className="container-fluid navHeight">
            ...
            >
              <ul className="navbar-nav me-2 mb-2 mb-lg-0">
                ...
                <li className="nav-item">
                  <NavLink exact to= '/form' className="nav-link">
                    <div
                      className="marginInLi"
                      data-bs-toggle="collapse"
                      data-bs-target="#navbarSupportedContent"
                ...
                <li className="nav-item">
                  <NavLink exact to= '/fms' className="nav-link">
                    <div
                      className="marginInLi"
                      data-bs-toggle="collapse"
                      data-bs-target="#navbarSupportedContent"
                ...
                <li className="nav-item">
                  <NavLink exact to= '/helpticket' className="nav-link">
                    <div
                      className="marginInLi"
                      data-bs-toggle="collapse"
                      data-bs-target="#navbarSupportedContent"
                ...
                <li className="nav-item">
                  <NavLink exact to= '/yourticket' className="nav-link">
                    <div
                      className="marginInLi"
                      data-bs-toggle="collapse"
                      data-bs-target="#navbarSupportedContent"
